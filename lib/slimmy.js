(function() {
  ...
  Slimmy = (function() {
    ...
    _Class.prototype.convertDir = function(dirPath, writeToFile) {
      ...
      return Q.allSettled(_.map(files, (function(_this) {
        return function(filePath) {
          ...
          return _this.convertFile(filePath, writeToFile);
        };
    ...
    _Class.prototype.removeHamlFromDir = function(dirPath) {
      var filePath, files, walker, _i, _len, _results;
      dirPath = this.getAbsolutePath(dirPath);
      files = [];
      walker = walk.walkSync(dirPath, {
        followLinks: false,
      ...
      for (_i = 0, _len = files.length; _i < _len; _i++) {
        filePath = files[_i];
        console.log(filePath);
        _results.push(this.deleteHamlFile(filePath));
      }
      return _results;
    };
