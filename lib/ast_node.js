(function() {
  ...
  AstNode = (function() {
    ...
    AstNode.prototype.isIfKeyword = function() {
      return this.isSilentScript() && this.data.keyword === 'if';
    };
    ...
    AstNode.prototype.hasClass = function(classes) {
      var hasClass, klass, nodeClasses, _i, _len, _ref, _ref1;
      hasClass = false;
      if (!this.type === 'tag' || (((_ref = this.data) != null ? (_ref1 = _ref.attributes) != null ? _ref1["class"] : void 0 : void 0) == null)) {
        return hasClass;
      }
      nodeClasses = this.data.attributes["class"].split(' ');
      for (_i = 0, _len = classes.length; _i < _len; _i++) {
        klass = classes[_i];
        if (nodeClasses.indexOf(klass) !== -1) {
          hasClass = true;
          break;
        }
      }
