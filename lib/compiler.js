(function() {
  ...
  Compiler = (function() {
    ...
    Compiler.prototype.compileNode = function(node, indLevel) {
      ...
      this[compilationMethod](node, indLevel);
      if (this.fileCompilationMode) {
        if (this._shouldAppendEmptyLine(node)) {
    ...
    Compiler.prototype.compileAttrsHashes = function(hashes) {
      ...
      hashes = _.map(hashes, function(attrsHash) {
        var char, i, insideBrackets, insideHash, newAttrsHash, nextChar, prevChar, _i, _ref;
    ...
    Compiler.prototype._shouldAppendEmptyLine = function(node) {
      if (!this.fileCompilationMode || (config == null)) {
        return;
      }
      return config.shouldAppendEmptyLine(node);
    };
